...
class ConnectionGUIView: public AbstractGUIView {
	...
	InputBox username{ObjectInfo<>(WINDOW_WIDTH/3.f, WINDOW_HEIGHT/15.f, WINDOW_WIDTH/2.f - WINDOW_WIDTH/6.f, WINDOW_HEIGHT/2.f - WINDOW_HEIGHT/12.f), BOX_COLOR, SERIF_FONT_PATH};
	InputBox password{ObjectInfo<>(WINDOW_WIDTH/3.f, WINDOW_HEIGHT/15.f, WINDOW_WIDTH/2.f - WINDOW_WIDTH/6.f, WINDOW_HEIGHT/2.f + WINDOW_HEIGHT/12.f), BOX_COLOR, SERIF_FONT_PATH};
	Border username_border{username, 5};
	Border password_border{password, 5};

	ImageButton login_button{ObjectInfo<>(WINDOW_WIDTH/4.f, WINDOW_WIDTH/4.f * 230.f/839.f, WINDOW_WIDTH/6.f - WINDOW_WIDTH/50.f, WINDOW_HEIGHT/2.f + WINDOW_HEIGHT/5.f), LOGIN_BUTTON_PATH};
	ImageButton register_button{ObjectInfo<>(WINDOW_WIDTH/4.f, WINDOW_WIDTH/4.f * 230.f/839.f, WINDOW_WIDTH/2.f + WINDOW_WIDTH/50.f, WINDOW_HEIGHT/2.f + WINDOW_HEIGHT/5.f), REGISTER_BUTTON_PATH};
