...
public:
	...
	explicit MenuGUIView(sf::RenderWindow* window) : AbstractGUIView(window) {
		...
		create_popup.addButton(new ImageButton{ObjectInfo<>(WINDOW_WIDTH/12.f, WINDOW_HEIGHT/12.f, WINDOW_WIDTH/4.f, WINDOW_HEIGHT/4+WINDOW_HEIGHT/10*5.f-WINDOW_HEIGHT/12.f), BACK_BUTTON_PATH});
		create_popup.addButton(new ImageButton{ObjectInfo<>(WINDOW_WIDTH/12.f, WINDOW_HEIGHT/12.f, WINDOW_WIDTH/4*3-WINDOW_WIDTH/12.f, WINDOW_HEIGHT/4+WINDOW_HEIGHT/10*5.f-WINDOW_HEIGHT/12.f), OK_BUTTON_PATH});
	}
