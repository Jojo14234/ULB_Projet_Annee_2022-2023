...
class FriendsGUIView: public AbstractGUIView {
	...
	Box friend1_box{ObjectInfo<>(fbox_x_size, fbox_y_size, fbox_x_pos,fbox_y_pos), TOP_BOX_COLOR};
	Box friend2_box{ObjectInfo<>(fbox_x_size, fbox_y_size, fbox_x_pos,fbox_y_pos+10+fbox_y_size), TOP_BOX_COLOR};
	Box friend3_box{ObjectInfo<>(fbox_x_size, fbox_y_size, fbox_x_pos,fbox_y_pos+20+fbox_y_size*2), TOP_BOX_COLOR};
	Box friend4_box{ObjectInfo<>(fbox_x_size, fbox_y_size, fbox_x_pos,fbox_y_pos+30+fbox_y_size*3), TOP_BOX_COLOR};
	Box friend5_box{ObjectInfo<>(fbox_x_size, fbox_y_size, fbox_x_pos,fbox_y_pos+40+fbox_y_size*4), TOP_BOX_COLOR};
	...
	ImageButton mess2_button{ObjectInfo<>(fbutton_size, fbutton_size, mess_button_x, fbox_y_pos+10+15 + fbox_y_size), MESSAGE_BUTTON_PATH};
	ImageButton del2_button{ObjectInfo<>(fbutton_size, fbutton_size, del_button_x, fbox_y_pos+10+15 + fbox_y_size), DELETE_BUTTON_PATH};

	ImageButton mess3_button{ObjectInfo<>(fbutton_size, fbutton_size, mess_button_x, fbox_y_pos+20+15 + fbox_y_size*2), MESSAGE_BUTTON_PATH};
	ImageButton del3_button{ObjectInfo<>(fbutton_size, fbutton_size, del_button_x, fbox_y_pos+20+15 + fbox_y_size*2), DELETE_BUTTON_PATH};

	ImageButton mess4_button{ObjectInfo<>(fbutton_size, fbutton_size, mess_button_x, fbox_y_pos+30+15 + fbox_y_size*3), MESSAGE_BUTTON_PATH};
	ImageButton del4_button{ObjectInfo<>(fbutton_size, fbutton_size, del_button_x, fbox_y_pos+30+15 + fbox_y_size*3), DELETE_BUTTON_PATH};
